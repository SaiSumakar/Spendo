  ...
  return (
    <div className="space-y-6 sm:space-y-7">
      ...
      <div className="relative w-fit max-w-full">
        <div className="inline-flex gap-2 overflow-x-auto pb-2 relative">
          {menuItems.map((item) => {
            ...
            return (
              <Button
                ...
                variant="ghost"
                className={cn(
                  "relative gap-2 rounded-lg whitespace-nowrap shrink-0 transition-colors",
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex justify-between items-center p-4 border border-red-200 rounded-lg bg-red-50 dark:bg-red-900/10 dark:border-red-900">
                  <div className='flex flex-col'>
                    <h3 className="font-medium text-red-600 flex items-center gap-2"><Shield className="w-4 h-4"/> Danger Zone</h3>
                    <p className="text-sm text-red-600/80 mt-2">Once you delete your account, there is no going back.</p>
                  </div>
                  <Button 
                    variant="destructive" 
                    className="gap-2"
